...
{
    internal class OrFilterSpec<T>(IDynamicFilter<T> one, IDynamicFilter<T> other) : CompositeFilterSpec<T>
    {
        ...
        public override Expression<Func<T, bool>> AsExpression()
        {
            ...
            BinaryExpression newBodyExpression = Expression.OrElse(oneLambdaExpression.Body, replacer.Visit(otherLambdaExpression.Body)!);
