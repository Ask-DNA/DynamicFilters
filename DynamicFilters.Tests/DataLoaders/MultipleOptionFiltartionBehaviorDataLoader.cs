...
{
    public class MultipleOptionFiltartionBehaviorDataLoader : TheoryData<
            List<MultipleOptionFiltartionBehaviorDataLoader.Entity>,
            DynamicFilterBase<MultipleOptionFiltartionBehaviorDataLoader.Entity>,
            Func<MultipleOptionFiltartionBehaviorDataLoader.Entity, bool>>
    {
        ...
        public MultipleOptionFiltartionBehaviorDataLoader()
        {
            Add(
                _entities,
