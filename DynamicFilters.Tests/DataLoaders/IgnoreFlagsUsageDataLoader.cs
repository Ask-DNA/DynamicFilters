...
{
    internal class IgnoreFlagsUsageDataLoader : TheoryData<
            List<IgnoreFlagsUsageDataLoader.Entity>,
            DynamicFilterBase<IgnoreFlagsUsageDataLoader.Entity>,
            Func<IgnoreFlagsUsageDataLoader.Entity, bool>>
    {
        ...
        public IgnoreFlagsUsageDataLoader()
        {
            Add(
                _entities,
